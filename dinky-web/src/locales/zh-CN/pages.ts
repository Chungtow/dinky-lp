...
export default {
  ...
  'datastudio.aiChat.explainCurrentSql': '请解释当前编辑器中的 SQL',
  'datastudio.aiChat.noSqlToExplain': '编辑器中没有可解释的 SQL',
  'datastudio.aiChat.insertToEditor': '插入编辑器',
  ...
  'rc.ds.detail.tag.erdiagram': 'ER 图',
  'rc.ds.detail.tag.gensql': '生成 SQL',
  'rc.ds.detail.tag.query': '查询',
  'rc.ds.erdiagram.visual': '可视化',
  'rc.ds.erdiagram.source': '源代码',
  'rc.ds.erdiagram.copy': '复制',
  ...
  'rc.ds.erdiagram.selectHint': '拖动可平移；开启「选择模式」后拖动可选中复制文字',
  'rc.ds.erdiagram.selectMode': '选择模式（选中并复制文字）',
